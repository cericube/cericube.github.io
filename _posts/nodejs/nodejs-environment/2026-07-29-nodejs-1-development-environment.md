---
layout: post
title: "1. VSCode·WSL·Remote-SSH 기반 Node.js 개발 환경 구축"
description: "Windows에서 VSCode와 WSL·Ubuntu에 Node.js 개발 환경을 구축하고, Remote-SSH와 VSCode Server를 이용해 로컬 및 원격 Linux 환경에 연결하는 방법을 정리합니다."
...
<h2 id="session-01">1. VS Code-WSL 기반 Node.js 개발 환경 설치</h2>
...
https://code.visualstudio.com/download 에 접속합니다.  
...
### 🟦 WSL 설치
WSL(Windows Subsystem for Linux)은 Windows에서 Linux를 가상 머신 없이 실행할 수 있도록 지원하는 기능입니다.    
...
<h2 id="session-02">2. VS Code Remote-SSH 원격 개발 환경 구성</h2>
...
<h2 id="session-03">3. VS Code와 WSL 연동</h2>
...
<h2 id="session-04">4. 프로젝트별 Node.js 버전 자동 적용</h2>
...
```
{
  "terminal.integrated.env.linux": {
    "PATH": "/home/ubuntu/runtimes/node-v22.23.1-linux-x64:$PATH"
  }
}
```
...
{
  "terminal.integrated.env.linux": {
    "PATH": "/home/ubuntu/runtimes/node-v24.18.0-linux-x64:$PATH"
  }
}
```
...
![alt text](/assets/images/nodejs/nodejs-environment/image-9.png)
